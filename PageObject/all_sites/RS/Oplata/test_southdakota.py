...
link = 'http://www.southdakotaonlinedivorce.com/'
browser.get(link)
...
#Platinum/Vip page
#try:
    #lnk111 = browser.find_element_by_xpath('/html/body/main/main/div[8]/a').click()
#except:
    #lnk111 = browser.find_element_by_xpath('/html/body/main/main/div[5]/a').click()
browser.quit()
