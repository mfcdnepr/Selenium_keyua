...
link = 'https://www.californiaonlinedivorce.com/'
browser.get(link)
...
browser.find_element_by_xpath('//*[@id="id_spouse_location_1"]').click()
browser.find_element_by_xpath('//*[@id="id_spouse_location_address"]').send_keys('Karla Marksa 100 St')
browser.find_element_by_xpath('//*[@id="id_dt_last_contact_with_spouse"]').send_keys('10102010')
browser.find_element_by_xpath('//*[@id="id_spouse_is_duty_military_1"]').click()
browser.find_element_by_xpath('/html/body/main/div/div[2]/div/div/section/form/button').click()
time.sleep(2)
try:
    browser.find_element_by_xpath('//*[@id="skipMissingSpouse"]/span').click()
except:
    time.sleep(2)
...
time.sleep(2)
try:
    browser.find_element_by_xpath('//*[@id="id_without_phone_number"]').click()
except:
    browser.find_element_by_xpath('//*[@id="id_ccnum"]').click()
