...
link = 'https://www.onlinedivorce.com/online-divorce-california/?h1=Start%20Your%20Annulment%20in%20California%20Without%20Lawyer%20Fees&type=divorce'
browser.get(link)
browser.implicitly_wait(25)
...
#time.sleep(1)
#browser.find_element_by_xpath('//*[@id="id_state_of_filing"]/option[47]').click()
